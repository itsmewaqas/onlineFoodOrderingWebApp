...
import { removeToCart, ordersuccess } from '../redux/Actions/index';
...
function Checkout(props) {
  ...
  let sum = data.addtocart.cardData.reduce(function (prev, current) {
    ...
    <div>
      ...
      {data.addtocart.cardData.length == 0 ? null :
        <div className='container clearfix'>
          ...
          <dd className='checkOutAmmount'>Total Amount :${sum}</dd>
